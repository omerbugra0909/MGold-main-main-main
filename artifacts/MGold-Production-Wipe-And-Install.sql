/*
  DANGER: This script drops MGold application tables before installing the current schema.
  Use only when the target database has no production data to keep, or after a verified backup.
*/

IF OBJECT_ID(N'[WorkTaskHistoryEntries]', N'U') IS NOT NULL DROP TABLE [WorkTaskHistoryEntries];
IF OBJECT_ID(N'[WorkTasks]', N'U') IS NOT NULL DROP TABLE [WorkTasks];
IF OBJECT_ID(N'[OrderPayments]', N'U') IS NOT NULL DROP TABLE [OrderPayments];
IF OBJECT_ID(N'[OrderItems]', N'U') IS NOT NULL DROP TABLE [OrderItems];
IF OBJECT_ID(N'[OrderInvoices]', N'U') IS NOT NULL DROP TABLE [OrderInvoices];
IF OBJECT_ID(N'[OrderHistoryEntries]', N'U') IS NOT NULL DROP TABLE [OrderHistoryEntries];
...
IF OBJECT_ID(N'[AccountVerificationTokens]', N'U') IS NOT NULL DROP TABLE [AccountVerificationTokens];
IF OBJECT_ID(N'[Transactions]', N'U') IS NOT NULL DROP TABLE [Transactions];
IF OBJECT_ID(N'[ProductReviews]', N'U') IS NOT NULL DROP TABLE [ProductReviews];
IF OBJECT_ID(N'[CustomerFavorites]', N'U') IS NOT NULL DROP TABLE [CustomerFavorites];
IF OBJECT_ID(N'[MarketWatchlistItems]', N'U') IS NOT NULL DROP TABLE [MarketWatchlistItems];
IF OBJECT_ID(N'[AppUsers]', N'U') IS NOT NULL DROP TABLE [AppUsers];
IF OBJECT_ID(N'[Products]', N'U') IS NOT NULL DROP TABLE [Products];
IF OBJECT_ID(N'[Customers]', N'U') IS NOT NULL DROP TABLE [Customers];
IF OBJECT_ID(N'[MarketQuoteSnapshots]', N'U') IS NOT NULL DROP TABLE [MarketQuoteSnapshots];
IF OBJECT_ID(N'[MarketProviderConfigurations]', N'U') IS NOT NULL DROP TABLE [MarketProviderConfigurations];
IF OBJECT_ID(N'[Notifications]', N'U') IS NOT NULL DROP TABLE [Notifications];
IF OBJECT_ID(N'[GoldPrices]', N'U') IS NOT NULL DROP TABLE [GoldPrices];
IF OBJECT_ID(N'[ContactMessages]', N'U') IS NOT NULL DROP TABLE [ContactMessages];
IF OBJECT_ID(N'[Companies]', N'U') IS NOT NULL DROP TABLE [Companies];
